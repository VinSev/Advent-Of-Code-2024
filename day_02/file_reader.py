...
class FileReader:
    @staticmethod
    def _read(file_path: str, transformer: 'FileDataTransformer' = None) -> Any:
        try:
    ...
    @staticmethod
    def read_matrix(file_path: str, target_type: Type = str, separator: str = ' ') -> List[List[Any]]:
...
class FileDataTransformerToMatrix(FileDataTransformer):
    def __init__(self, target_type: Type = str, separator: str = ' '):
        self._target_type = target_type
